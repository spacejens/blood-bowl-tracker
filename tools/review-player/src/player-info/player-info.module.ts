 ...
 * match aggregate, an imported panel from the database, and a random-sample
 * stratum both other data types can reuse.
 */
@Module({
  ...
  exports: [PlayerInfoReviewerService, RandomPlayerStratificationService],
})
