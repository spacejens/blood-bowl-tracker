 ...
 * many teams, so today's data model gives them one `players` row per hire — if
 * left in the general pool they crowd out ordinary players in a report
 * several-fold. The random-sample stratum excludes star
