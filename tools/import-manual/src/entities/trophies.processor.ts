...
export class TrophiesProcessor {
   ...
   * belongs to; an entry naming an unknown group is skipped (an authoring
   * error), while an entry that omits one passes `competitionGroupId:
   * undefined` through, leaving the trophy's stored group alone.
   *
