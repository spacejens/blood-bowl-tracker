 ...
 *
 * The conflict error class is passed in rather than inferred: each entity has
 * its own exported class, and those are public API.
 */
export async function runUpsert<TEntity extends object>(
