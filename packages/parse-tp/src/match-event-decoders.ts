...
import type { SecretObjectiveService } from './secret-objective.service';
import type { WeatherTypeService } from './weather-type.service';
...
export function buildDecoders(
  secretObjective: SecretObjectiveService,
  weatherType: WeatherTypeService,
): Map<number, Decoder> {
  return new Map<number, Decoder>([
    ...
    [
      ...
      decode(weatherRaw, 10, (v) => ({
        ...
        tpEventId: v.id,
        instant: v.instant,
        weatherType: weatherType.decode(v.extraData.weatherType),
      })),
    ],
    [
      11,
    ...
    [
      ...
      decode(secretObjectiveRaw, 42, (v) => ({
        ...
        instant: v.instant,
        rosterId: v.rosterId,
        secretObjective: secretObjective.decode(v.extraData.secretObjective),
      })),
    ],
    [
      46,
