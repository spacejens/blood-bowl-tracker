...
export const DEEPDIVE_POSITION_KEYWORDS_TIMEOUT_MESSAGE =
  'The clerk is still deciding what to call this lot in the rulebook.';
...
export const DEBUG_NO_USAGE_RECORDED_MESSAGE =
