...
An [era](../../glossary.md#era) captures which [rules set](../rules-sets/index.md) a [league](../leagues/index.md) used during a particular period of time.
...
- Each [competition](../competitions/index.md) belongs to exactly one era.
