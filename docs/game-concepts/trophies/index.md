...
A trophy is a curated, named award a [team](../../glossary.md#team) or an individual [player](../../glossary.md#player) can win.
...
- Trophies are curated by hand rather than inferred from source data, for the same reason [competition groups](../competitions/index.md#competition-groups) are: a source system's label text alone (e.g. `1st`) cannot disambiguate which trophy is meant. See [docs/import-manual](../../import-manual/index.md) for how the curated catalog is maintained.

## Trophy award

A trophy award is one concrete instance of a trophy being given out, in one [competition](../competitions/index.md), to one recipient.
