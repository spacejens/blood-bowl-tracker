...
docs/
  ...
  api/                     # Spec style: general API concepts (REST conventions, imports); not per-entity docs
...
`docs/` holds three kinds of document, and different expectations apply to each:
