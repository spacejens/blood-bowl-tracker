...
- **Kind labels come from the "Issue labels" section of [docs/development-workflow.md](../../../docs/development-workflow.md)**, reached through `write-issue`'s Phase 3 step 3, which already applies it. Do not duplicate that logic in this file either.
